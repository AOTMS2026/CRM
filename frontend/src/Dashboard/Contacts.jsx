                ...
                >
                  ...
                  <div className="pt-2 flex items-center justify-between gap-1.5 border-t border-slate-100">
                    <button
                      ...
                      className="py-1.5 px-3 rounded-xl bg-sky-50 hover:bg-sky-100 text-sky-700 font-extrabold text-xs flex items-center justify-center gap-1.5 border border-sky-200 transition-all cursor-pointer flex-1"
            ...
            <div className="flex items-center justify-between pb-4 border-b border-slate-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 font-medium">
                    Update profile details for <span className="font-extrabold text-slate-800">{editingContact.name}</span>
                  </p>
                </div>
              </div>
            ...
            <form onSubmit={handleUpdateContactSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-xs font-bold text-slate-900 bg-slate-50 focus:bg-white focus:outline-none focus:border-sky-500"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-xs font-mono font-bold text-slate-500">+91</span>
                  <input
                    type="tel"
                    required
                    maxLength={10}
                    ...
                    className="w-full pl-12 pr-3.5 py-2.5 rounded-xl border border-slate-200 text-xs font-bold font-mono text-slate-900 bg-slate-50 focus:bg-white focus:outline-none focus:border-sky-500"
                  />
                </div>
              </div>
              ...
              {/* Identity */}
              <div>
                <label className="block text-xs font-bold text-slate-700 mb-1">Contact Identity</label>
                <input
                  type="text"
              ...
              <div className="pt-4 border-t border-slate-200 flex items-center justify-end gap-3">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="px-6 py-2.5 rounded-xl bg-sky-600 hover:bg-sky-700 text-white font-extrabold text-xs shadow-md cursor-pointer disabled:opacity-50"
                >
